"""
Django settings for ECompareApp project.
...
SECRET_KEY = 'django-insecure-%mbfa_6&!59jw&)4@-d+i-rt9()k7%etx6y46drv*k12xc6nv$'
...
WSGI_APPLICATION = 'ECompareApp.wsgi.application'
